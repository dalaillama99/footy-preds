  ...
  return (
    <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl px-8 py-8 max-w-sm w-full shadow-xl">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">If you also get the exact scoreline right, the whole package — exact score + correct pen winner — is worth <strong>4 pts</strong> in total.</p>
