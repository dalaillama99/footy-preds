    ...
    <div>
      ...
      {selectedCompetitions.includes('CL') && (
        <div className="mb-3">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mb-1.5">Any Champions League game involving a team you select here will be shown or count for this league — even if the opponent isn't selected.</p>
